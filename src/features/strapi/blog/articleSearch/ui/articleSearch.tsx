  ...
  return (
    <div className="relative">
      <input
        ...
        className="rounded-[12px] bg-[#000] text-[#fff] px-4 py-3 pr-10 w-full placeholder:text-[#fff] text-[10px] uppercase focus:outline-none placeholder:transition-opacity placeholder:duration-400 focus:placeholder:opacity-0 placeholder:opacity-1"
