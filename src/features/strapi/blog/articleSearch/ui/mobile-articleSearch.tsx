  ...
  return (
    <div className="relative md:hidden block">
      <input
        ...
        className="rounded-[10px] bg-new-light-grey text-white px-3 py-2 pl-12 w-full placeholder:text-font-light-grey focus:outline-none placeholder:transition-opacity placeholder:duration-400 focus:placeholder:opacity-0 placeholder:opacity-1 font-light"
