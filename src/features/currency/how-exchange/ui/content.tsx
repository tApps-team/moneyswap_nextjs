export const HowExchangeContent = () => {
  return (
    <>
      <p className="grid grid-cols-[30px_1fr] gap-5 items-start justify-start">
        ...
        <span className="md:text-sm text-xs font-light text-white">
      ...
      <p className="grid grid-cols-[30px_1fr] gap-5 items-start justify-start">
        ...
        <span className="md:text-sm text-xs font-light text-white">
          Перейдите на сайт обменника или в чат с менеджером по обмену для создания заявки.
        </span>
      </p>
      <p className="grid grid-cols-[30px_1fr] gap-5 items-start justify-start">
        <span className="font-medium w-[30px] h-[30px] flex justify-center items-center text-xs text-black rounded-[5px] bg-yellow-main">
      ...
      <p className="grid grid-cols-[30px_1fr] gap-5 items-start justify-start">
        ...
        <span className="md:text-sm text-xs font-light text-white">
          Поделитесь своим опытом с другими пользователями, оставив отзыв на MoneySwap.
        </span>
      </p>
    </>
  );
