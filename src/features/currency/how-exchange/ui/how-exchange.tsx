    ...
    <>
      {hover ? (
        <HoverCard openDelay={0}>
          <HoverCardTrigger asChild>
            <div className="cursor-pointer w-full h-full uppercase px-4 py-3 rounded-[10px] border-[1px] border-white grid justify-items-stretch justify-stretch items-center">
              <p className="lx:text-sm text-xs text-center font-normal">как совершить обмен?</p>
            </div>
          </HoverCardTrigger>
        ...
        <AlertDialog>
          ...
          >
            <div className="lg:px-4 lg:py-3 mobile-xl:px-2.5 mobile-xl:py-2 px-1.5 py-0.5">
