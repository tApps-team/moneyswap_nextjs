...
export const CurrencyPair = (props: CurrencyPairProps) => {
  ...
  return (
    <Link
      href={createUrl()}
      className="px-2 py-2 grid mobile-xl:min-w-24 gap-1 grid-flow-col mobile-xl:min-h-12 grid-rows-1 justify-between items-center rounded-[35px] shadow-[5px_5px_10px_0px_rgba(0,0,0,0.7)] bg-dark-gray hover:shadow-[5px_5px_5px_0px_rgba(0,0,0,0.7)] hover:scale-[1.01] transition-all duration-300"
    >
      <Image
