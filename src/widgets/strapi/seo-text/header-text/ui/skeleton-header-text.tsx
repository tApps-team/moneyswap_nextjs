  ...
  return (
    <section className="grid lg:grid-cols-[1fr_1fr] grid-cols-1 justify-between lg:mb-[70px] mobile-xl:mb-10 mb-5">
      <div className="grid grid-flow-row lg:gap-10 mobile-xl:gap-[30px] gap-3">
        ...
        <h1 className="text-yellow-main uppercase flex flex-col lg:gap-5 gap-2">
          <Skeleton className="w-[15vw] xl:h-[36px] lg:h-[36px] md:h-[32px] mobile-xl:h-[28px] mobile:h-[20px] h-[16px] bg-skeleton-gray text-skeleton-gray" />
          <Skeleton className="xl:text-2xl lg:text-xl md:text-2xl mobile-xl:text-xl mobile:text-base mobile-xs:text-sm text-xs font-medium bg-skeleton-gray text-skeleton-gray w-[80%] md:h-[32px] mobile-xl:h-[28px] mobile:h-[20px] h-[16px]" />
        ...
        <div className="lg:grid grid-flow-row gap-2 hidden max-w-[90%] mt-3">
