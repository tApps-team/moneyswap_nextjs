    ...
    <>
      <div className="grid gap-[20px]">
        <div className="relative">
          ...
          <Skeleton className="h-[38px] w-3/4 bg-skeleton-gray text-skeleton-gray" />
        ...
        <div className="strapi_styles text-sm flex flex-col gap-1 max-h-[68px]">
          <Skeleton className="h-5 w-11/12 bg-skeleton-gray text-skeleton-gray" />
          <Skeleton className="h-5 w-full bg-skeleton-gray text-skeleton-gray" />
          <Skeleton className="h-5 w-1/3 bg-skeleton-gray text-skeleton-gray" />
        </div>
      </div>
    </>
  );
