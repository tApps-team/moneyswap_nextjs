...
export const DynamicContent: FC<DynamicContentProps> = ({ dynamic_content }) => {
  return (
              ...
              >
                <AccordionItem value={`Value-${item.accordion.question}`} className="">
                  ...
                  <AccordionContent className="pb-0">
                    <div className="strapi_fonts_codec mt-6 md:mb-[20px] mb-[10px] text-sm font-light text-light-gray strapi_styles blog-custom-accordion-answer">
