...
import { EsimPromocode } from "@/entities/strapi";
import { cn } from "@/shared/lib";
import { routes } from "@/shared/router";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/shared/ui";

interface EsimPromoTooltipProps {
  slug: string;
...
export function EsimPromoTooltip({ slug, promocodes, className }: EsimPromoTooltipProps) {
