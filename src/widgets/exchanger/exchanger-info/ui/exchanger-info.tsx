...
export const ExchangerInfo = () => {
  return (
    <section className="rounded-2xl w-full grid gap-4   bg-gradient-to-r from-[#bbbbbb] from-0% to-35% to-[#2d2d2d] p-6 shadow-[1px_3px_10px_3px_rgba(0,0,0,0.7)]">
      ...
      <div className="grid grid-cols-6 grid-rows-2 gap-4">
        ...
        <Link href={"/"}>
          <div className="rounded-2xl shadow-[1px_3px_10px_3px_rgba(0,0,0,0.7)] bg-[#2d2d2d] text-[#f6ff5f] h-full flex flex-col items-center justify-center p-4 ">
        ...
        <div className="grid grid-cols-3  bg-[#2d2d2d] col-span-4  grid-rows-1 gap-4">
