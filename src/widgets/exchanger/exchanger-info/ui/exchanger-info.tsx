...
export const ExchangerInfo = async (props: ExchangerInfoProps) => {
  ...
  return (
    <section className="rounded-2xl w-full grid gap-4    bg-gradient-to-r from-light-gray from-0% to-20% to-dark-gray p-6 shadow-[1px_3px_10px_3px_rgba(0,0,0,0.7)]">
      ...
      <div className="grid grid-cols-[0.3fr,0.8fr]  gap-4 ">
        ...
        <div className="grid gap-4 grid-cols-4  grid-rows-2">
          ...
          <div className="rounded-2xl shadow-[1px_3px_10px_3px_rgba(0,0,0,0.7)] bg-dark-gray flex flex-col items-center justify-center p-4">
            ...
            <p className="text-yellow-main font-medium text-center">
          ...
          <div className="rounded-2xl shadow-[1px_3px_10px_3px_rgba(0,0,0,0.7)] bg-dark-gray  flex flex-col items-center justify-center p-4">
            ...
            <p className="text-yellow-main font-medium">{exchangerDetails.country}</p>
          </div>
          <div className="grid grid-cols-3 col-span-4 bg-dark-gray  gap-4">
            <div className="rounded-2xl shadow-[1px_3px_10px_3px_rgba(0,0,0,0.7)]  flex flex-col items-center justify-center p-4  ">
              ...
              <p className="text-yellow-main font-medium">{exchangerDetails.exchangeRates}</p>
            </div>
            <div className="rounded-2xl shadow-[1px_3px_10px_3px_rgba(0,0,0,0.7)]  bg-dark-gray  flex flex-col items-center justify-center p-4">
