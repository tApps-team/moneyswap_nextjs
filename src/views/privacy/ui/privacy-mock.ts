...
export const privacyMockData: DynamicContentItem[] = [
  ...
  },
  {
    ...
    paragraph: {
      ...
      content: `
        ...
        <ul>
          <li>адрес электронной почты, указываемый при регистрации, подписке на уведомления, а так же, телеграмм аккаунт при обращении через <a href="https://www.moneyswap.online/contacts" >форму обратной связи</a> или оставлении отзывов;</li>
  ...
  },
  {
    ...
    paragraph: {
      ...
      title_position: ComponentPosition.left,
      content: `
        <p>5.1. Пользователь вправе в любой момент запросить удаление своих персональных данных, отправив обращение через <a href="https://www.moneyswap.online/contacts">форму обратной связи</a> на Сайте.</p>
