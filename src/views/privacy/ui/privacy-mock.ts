  ...
  },
  {
    ...
    paragraph: {
      ...
      content: `
        ...
        <ul>
          <li>адрес электронной почты, указываемый при регистрации, подписке на уведомления, а так же, телеграмм аккаунт при обращении через форму обратной связи или оставлении отзывов;</li>
