...
export const PricingPolicyPage = async () => {
  ...
  return (
    <section className="">
      <h1 className="sr-only">Политика тарификации и возврата средств</h1>
      <h2 className="sr-only">
        Настоящая Политика тарификации и возврата средств определяет порядок оплаты услуг размещения обменных пунктов на сайте MoneySwap.
      </h2>
