import { EsimReview, EsimReviewRating } from "../api/esim-dto";

const ratingScoreMap: Record<EsimReviewRating, number> = {
  positive: 5,
  neutral: 3,
  negative: 1,
};

export function getEsimRating(reviews: EsimReview[]) {
...
export function getEsimReviewBreakdown(reviews: EsimReview[]) {
