...
export default async function Page() {
  ...
  const jsonLd = {
    ...
    "@type": "ItemList",
    "name": "Список обменников MoneySwap. Только проверенные вручную обменные пункты.",
    "description": "Сравните условия лучших обменников на MoneySwap. Выбирайте выгодные курсы, изучайте рейтинги, оставляйте отзывы и находите проверенные обменные пункты.",
...
export const metadata: Metadata = {
  title: "Список обменников MoneySwap. Только проверенные вручную обменные пункты.",
  description:
    "Сравните условия лучших обменников на MoneySwap. Выбирайте выгодные курсы, изучайте рейтинги, оставляйте отзывы и находите проверенные обменные пункты.",
